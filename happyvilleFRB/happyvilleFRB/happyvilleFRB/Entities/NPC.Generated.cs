...
{
	public partial class NPC : PositionedObject, IDestroyable
	{
        ...
        public NPC(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public NPC(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (IsStaticContentLoaded == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("NPCStaticUnload", UnloadStaticContent);
